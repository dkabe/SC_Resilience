...
demand = np.loadtxt("/home/dkabe/Model_brainstorming/SAA_Analysis_v6/Instance_1/eval_set_demand.txt").reshape((5000,3,29))
text_file = open("/home/dkabe/Model_brainstorming/SAA_Analysis_v6/Instance_1/Evaluation_Set.txt", "r")
...
def InitializeModelParams(num_Scenarios, batch):
    global x_i
    global x_j
    path = "/home/dkabe/Model_brainstorming/SAA_Analysis_v6/Instance_1/Opening_Decisions/"
...
def PrintToFileSummaryResults(num_Scenarios, batch):
    results_file = "/home/dkabe/Model_brainstorming/SAA_Analysis_v6/Instance_1/Upper_Bounds/" + str(num_Scenarios) + "_scenarios/" + str(num_Scenarios) + "_" + str(batch) + "_UB_results" + ".txt"
...
def run_Model(num_Scenarios, s1, batch, instance=0, rl=0.5, Manufacturing_plants=6, Distribution=4, Market=29, Products=3, Outsourced=3, epsilon=1500000):
