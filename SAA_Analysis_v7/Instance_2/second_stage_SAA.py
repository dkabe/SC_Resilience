...
demand = np.loadtxt("/home/dkabe/Model_brainstorming/SAA_Analysis_v7/Instance_2/eval_set_demand.txt").reshape((10000,3,29))
text_file = open("/home/dkabe/Model_brainstorming/SAA_Analysis_v7/Instance_2/Evaluation_Set.txt", "r")
...
def InitializeModelParams(num_Scenarios, batch):
    global x_i
    global x_j
    path = "/home/dkabe/Model_brainstorming/SAA_Analysis_v7/Instance_2/Opening_Decisions/"
...
def PrintToFileSummaryResults(num_Scenarios, batch):
    results_file = "/home/dkabe/Model_brainstorming/SAA_Analysis_v7/Instance_2/Upper_Bounds/" + str(num_Scenarios) + "_scenarios/" + str(num_Scenarios) + "_" + str(batch) + "_UB_results" + ".txt"
