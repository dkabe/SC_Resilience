...
def InitializeModelParams(instance, rl):
    global ranges
    temp_path = '/home/dkabe/SC_Resilience/Epsilon_Constraint/Three_Objectives/Instance_' + str(instance + 1) + '/Ranges/' + str(rl) + '_' + 'ranges.txt'
...
def PrintToFileSummaryResults(instance, rl):
    results_file = '/home/dkabe/SC_Resilience/Epsilon_Constraint/Three_Objectives/Instance_' + str(instance + 1) + '/e_cons_results_' + str(rl) + '.txt'
    if grbModel.status == GRB.OPTIMAL:
