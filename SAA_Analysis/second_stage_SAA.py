...
Scenarios = []
demand = np.loadtxt("/home/dkabe/Model_brainstorming/SAA_Analysis/eval_set_demand.txt").reshape((1024,3,29))

text_file = open("/home/dkabe/Model_brainstorming/SAA_Analysis/Evaluation_Set.txt", "r")
