...
def InitializeModelParams(num_Scenarios, Market, Products, batch):
    ...
    global demand
    path = '/home/dkabe/Model_brainstorming/SAA_Analysis_v5/Instance_1/'
...
def PrintToFileSummaryResults(num_Scenarios):
    results_file = "/home/dkabe/Model_brainstorming/SAA_Analysis_v5/Instance_1/Objectives/" + str(num_Scenarios) + "_results" + ".txt"
...
def SaveOpeningDecisions(num_Scenarios, batch):
    results_file = "/home/dkabe/Model_brainstorming/SAA_Analysis_v5/Instance_1/Opening_Decisions/" + str(num_Scenarios) + "_scenarios/" + str(num_Scenarios) + "_" + str(batch) + "_opening_decisions" + ".txt"
